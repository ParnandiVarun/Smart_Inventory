    ...
    <div className={`landing-container ${darkMode ? "dark" : ""}`}>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p>
            AI-powered inventory management with real-time tracking, alerts, and
            forecasts.
          </p>
          <motion.div
      ...
      <section className="features">
        ...
        <div className="feature-grid">
          {[
            [
              "📋 Track Items",
              "Maintain accurate item records with expiry, quantity, and categories.",
            ],
            [
              "🔔 Alerts",
              "Get notified for low-stock and expired items in real-time.",
            ],
            [
              "📊 Smart Reports",
              "Generate insightful reports on inventory performance and trends.",
            ],
            [
              "👥 Role-Based Access",
              "Assign roles like admin, manager, or viewer with permission control.",
            ],
          ].map(([title, desc], i) => (
            <motion.div
      ...
      <footer className="landing-footer">
        <div className="footer-grid">
          <div>
            <h4>About</h4>
            <p>
              SmartInventory is your intelligent inventory management partner —
              helping businesses optimize their stock with AI insights.
            </p>
          </div>
          <div>
            <h4>Quick Links</h4>
